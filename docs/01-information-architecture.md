...
| 商品与推广资产 | 准备伙伴可使用的商品与促销内容 | Product Feed、优惠券、文案/邮件、横幅/图片 | Product Feed/优惠券为 `C`，其他为 `R` |
...
| 集成与设置 | 管理品牌、店铺、团队、权限、API 和安全 | 品牌集成、Shopify、权限、支付/订阅、API | 权限为 `C`，其他多为 `R` |
...
| Creatives / Product Feed | 商品与推广资产 / 商品 Feed | 保留 Amazon 白名单、维护状态与上传历史 |
